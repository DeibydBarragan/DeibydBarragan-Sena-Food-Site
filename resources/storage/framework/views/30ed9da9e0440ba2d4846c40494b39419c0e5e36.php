<div class="modal fade" id="modificarProducto" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
      <form class="modal-content" action="<?php echo e(route('modificarse',$usuario->id )); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="modal-body">
            <div class="mb-3 d-flex gap-3 align-items-center">
              <div>
                ...
                <input name="nombre" type="text" class="form-control" maxlength="30" value=<?php echo e($usuario->Nombre); ?> required>
              </div>
              <div>
                <label class="col-form-label"><h5>Apellido</h5></label>
                <input name="apellido" type="text" class="form-control" maxlength="30" value="<?php echo e($usuario->Apellidos); ?>" required>
              </div>
            </div>
            <div>
            ...
            <div class="mb-3">
                <div>
                    ...
                    <input type="text" class="form-control" placeholder="<?php echo e($usuario->Tipousuarios->Rol); ?>" disabled>
                </div>
            </div>
            <div class="mb-3">
              <div>
                  <label class="col-form-label"><h5>Correo electrónico</h5></label>
                  <input type="text" class="form-control" placeholder="<?php echo e($usuario->Correo); ?>" disabled>
              </div>
            </div>
            <div class="mb-3">
                <div>
            ...
            <div class="mb-3">
                <div>
                    ...
                    <input type="text" class="form-control" placeholder="<?php echo e($usuario->Centros->Centro); ?>" disabled>
                </div>
            </div>
      ...
      <form action="<?php echo e(route('eliminarse', $usuario->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
  ...
  </div><?php /**PATH C:\laragon\www\Proyecto\resources\views/partials/modalModificarse.blade.php ENDPATH**/ ?>