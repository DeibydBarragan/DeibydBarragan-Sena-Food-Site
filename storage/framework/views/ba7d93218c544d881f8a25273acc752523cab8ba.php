    ...
    <div class="row">
          <div class="row col-md-9 col-lg-9 mt-2 gap-2 gap-sm-3 justify-content-center">
              <?php $__currentLoopData = $productosPedido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    <?php echo $__env->make('consumidor.partials.contenedorCarrito', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          ...
          <div class="col mt-2 mt-sm-0 col-sm-10 col-md-3">
              <div class="row p-3 rounded-3 shadow border border-1">
                  <h3>Suma</h3>
                  <h4><?php echo e($pedido->CantidadProductos); ?> producto(s)</h4>
                  <div class="row">
                    <div class="col col-8">
                      <h4>Total</h4>
                    </div>
                    <div class="col col-4">
                      <h4>$<?php echo e($pedido->Precio); ?></h4>
                    </div>
                  </div>
                  <div class="row mt-2 ms-1">
                    <?php echo $__env->make('consumidor.partials.contenedorMetodos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.plantillaPrincipal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Proyecto\resources\views/consumidor/carrito.blade.php ENDPATH**/ ?>